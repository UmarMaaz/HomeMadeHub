...
import { User, Lock, ArrowRight, ChefHat, Eye, EyeOff } from 'lucide-react';
...
function LoginPageContent() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (email === 'umarmaaz2637@gmail.com') {
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 transform transition-all duration-500 hover:shadow-2xl">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="/register" className="font-bold text-orange-600 hover:text-orange-700 transition-colors underline">
                Register here
              </a>
            </p>
